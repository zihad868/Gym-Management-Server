...
exports.loginTrainer = exports.registerTrainer = void 0;
...
const loginTrainer = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const isMatch = yield bcrypt_1.default.compare(password, trainer.password);
        if (!isMatch)
            return res.status(400).send('Invalid credentials');
        const token = jsonwebtoken_1.default.sign({ id: trainer._id, role: 'trainer' }, 'your-secret-key', { expiresIn: '1h' });
